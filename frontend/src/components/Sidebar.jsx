...
const Sidebar = () => {
  ...
  const sidebarContent = (
    <>
      ...
      <div className="px-5 pt-6 pb-5 border-b border-white/6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <User2 className="text-white size-7" />
            <div>
      ...
      {/* user profile card */}
      {username && (
        <div className="mx-3 mt-4 mb-1 p-3 rounnded-lg bg-white/3 border border-white/4">
          <div className="flex items-center gap-3">
            <div>
      ...
      <div className="px-5 pt-5 pb-2">
        <p className="text-[10px] font-semibold uppercase tracking-[0.12em] text-slate-500"></p>
      </div>
      {/* navigation list */}
      ...
      <div className="p-3 border-t border-white/6">
        <button
          ...
          className="flex items-center gap-3 w-full px-3 py-2.5 rounded-md text-[13px] font-medium transition-all duration-150"
        >
  ...
  return (
    <>
      ...
      {mobileOpen && (
        <div
          className="lg:hidden fixed insert-0 bg-black/60 backdrop-blur-sm z-40"
          onClick={() => setMobileOpen(false)}
        />
      )}

      {/* sidebar-desktop */}
      <aside className="hidden lg:flex flex-col h-full w-[260px] bg-linear-to-b from-slate-900 via-slate-900 to-slate-950 text-white shrink-0 border-r border-white">
        {sidebarContent}
      </aside>

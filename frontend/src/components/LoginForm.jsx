...
import { ArrowBigLeftIcon, EyeIcon, EyeOffIcon, Loader2 } from "lucide-react";
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-slate-200 rounded-lg text-sm text-slate-700 focus:outline-none focus:border-indigo-400 bg-slate-50"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  placeholder="........"
                  className="w-full px-4 py-3 border border-slate-200 rounded-lg text-sm text-slate-700 focus:outline-none focus:border-indigo-400 bg-slate-50 pr-11"
                />
                <button
